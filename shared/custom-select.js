...
.pc-custom-select-trigger{width:100%;min-height:var(--h-ctl,var(--pc-control-height,37px));display:flex!important;align-items:center!important;justify-content:space-between!important;gap:10px!important;min-width:0;padding:8px 10px;border:1px solid var(--line-2,var(--pc-line,#d4cfc0));border-radius:var(--r-sm,7px);background:var(--panel,var(--pc-field,var(--field,#fff)));background-image:none!important;color:var(--text,var(--pc-text,inherit));font:inherit;font-weight:inherit;line-height:1.4;text-align:left;cursor:pointer;box-shadow:none;filter:none}
