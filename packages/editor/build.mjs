...
const templateCatalog = Core.TEMPLATES.map(template => ({
  id: template.id,
  name: template.name,
  description: template.desc,
  category: template.category,
  keywords: template.keywords,
  preview: Core.templatePreview(template.id)
}));
writeFileSync(join(dist, 'templates.json'), JSON.stringify({
