...
| 2 | Draft/publication differences by page/CMS/shared assets and styles; immutable preview snapshots; comparison and historical restore as a new draft | Implemented; staging acceptance pending; see [release record](phase2-publication-release.md) |
