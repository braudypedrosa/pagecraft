...
const footer = () => [section([
  ...
  heading('Northline', 'display', 'h2', { d: { color: C('paper'), 'font-size': 'clamp(64px, 14vw, 180px)', 'line-height': '.78', 'letter-spacing': '-.07em', 'margin-top': '96px' }, t: {}, m: { 'font-size': '22vw', 'margin-top': '56px' } }),
