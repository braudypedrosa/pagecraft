...
export const sources=['builder.html','app/src/ui/Pages.tsx','app/src/ui/CmsWorkspace.tsx','app/src/ui/MotionPresence.tsx','app/src/ui/inspector/ColorPop.tsx','app/src/ui/inspector/Inspector.tsx','app/src/ui/inspector/Lists.tsx','shared/ui-tokens.js','shared/ui-fonts.js','shared/ui-typography.js','shared/ui-focus.js','shared/ui-motion.js','shared/workspace-styles.js','shared/dialog-styles.js','shared/custom-select.js','shared/action-feedback.js','shared/notify-menu.js','server/src/account-pages.ts','server/src/component-gallery.ts',...UI_FONT_FACES.map(font=>'brand/fonts/'+font.file)];
