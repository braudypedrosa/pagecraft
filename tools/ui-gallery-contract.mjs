...
export const sources=['builder.html','app/src/ui/Pages.tsx','app/src/ui/CmsWorkspace.tsx','shared/ui-tokens.js','shared/ui-fonts.js','shared/ui-typography.js','shared/ui-focus.js','shared/workspace-styles.js','shared/dialog-styles.js','shared/custom-select.js','shared/action-feedback.js','server/src/account-pages.ts','server/src/component-gallery.ts',...UI_FONT_FACES.map(font=>'brand/fonts/'+font.file)];
