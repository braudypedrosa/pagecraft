...
.account h1{font-size:clamp(1.55rem,4vw,1.9rem)}
...
const brand = (compact = false) => `<a class="brand${compact ? ' compact' : ''}" href="/" aria-label="Pagecraft sites"><img src="/brand/pagecraft-logo.svg?v=ink-2" width="488" height="106" alt="Pagecraft"></a>`;
