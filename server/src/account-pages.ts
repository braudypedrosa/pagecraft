...
const brand = (compact = false) => `<a class="brand${compact ? ' compact' : ''}" href="/" aria-label="Pagecraft sites"><img src="/brand/pagecraft-logo.svg?v=ink" width="482" height="95" alt="Pagecraft"></a>`;
